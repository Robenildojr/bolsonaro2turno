# Como a Íris lembra, aprende e esquece

Guardar transcrição não é memória — é arquivo morto. O que faz a assistente
...
Toda mensagem, sua e dela, é gravada cifrada com os blocos originais da API
...
| `insight` | padrão que ela percebeu | "Revisa petições no fim da tarde." |
...
5. **Retratar.** Reescreve o seu perfil a partir das memórias mais importantes.
   Esse texto entra no prompt de toda conversa — é o que faz ela falar com
...
e você aceitar mandar texto para fora, `IRIS_EMBEDDINGS=voyage` melhora
...
**Ela esquece o que eu mandei lembrar?** Não. Memória fixada (`pinned`) não
desbota e não é descartada.

**Dá para apagar algo?** Sim: `iris memoria esquecer <id>`, ou peça na conversa.
Apagar é apagar — sai do banco.

**E se ela aprender errado?** Corrija na conversa. A correção vira memória nova
com confiança alta e a antiga é marcada como substituída — você continua podendo
auditar o que ela achava antes.
