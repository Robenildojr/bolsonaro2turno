 ...
 *
 * É aqui que a Íris deixa de ser reativa. Sem este módulo ela responde bem,
 * mas só quando chamada; com ele, ela acompanha o dia: avisa da audiência,
...
export async function startScheduler(cfg: Config = loadConfig()): Promise<Scheduler> {
  ...
  // A agenda entra no contexto de toda conversa: ela precisa saber o que está
