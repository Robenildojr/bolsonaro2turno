 ...
 *
 *  1. o arquivo vai para o disco, em `~/.iris/cache/anexos`, cifrado;
 *  2. o histórico guarda apenas uma **referência** (`iris_anexo`), leve;
...
export function ehReferencia(bloco: unknown): bloco is ReferenciaAnexo {
  return Boolean(bloco) && (bloco as { type?: string }).type === 'iris_anexo';
}
