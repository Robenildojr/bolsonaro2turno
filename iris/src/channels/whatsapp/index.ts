 ...
 *
 *  1. **Só o dono fala com ela.** Mensagem de qualquer outro número é
 *     descartada e registrada. A Íris tem acesso ao computador, ao cofre e ao
 *     e-mail — um desconhecido conseguindo conversar com ela seria acesso
 *     remoto à sua máquina por uma mensagem de texto.
 *
 *  2. **Autorização também funciona pelo WhatsApp.** Se ela precisar de
