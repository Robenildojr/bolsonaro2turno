 ...
 *    da Íris parar de funcionar: é você perder o contato com os clientes.
 *
    ...
    socket.ev.on('connection.update', (dados) => {
      ...
      if (u.connection === 'close') {
        ...
        if (this.reconexoes < 6) {
          ...
          log.error('desisti de reconectar ao WhatsApp — reinicie a Íris para tentar de novo');
        }
      }
    });
