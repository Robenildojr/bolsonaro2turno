 ...
 *
 * Inclui a ferramenta pela qual o Gideão consulta as próprias autorizações. Isso
 * evita o padrão irritante de tentar uma ação, ser barrada e só então descobrir
 * que não podia — ele consegue verificar antes e propor o caminho certo.
 */
...
const infoSistema: ToolDefinition<Record<string, never>> = {
  name: 'info_sistema',
  description:
    'Informações do computador e do estado do Gideão: sistema operacional, memória, disco, data e hora, tamanho da base de memórias.',
