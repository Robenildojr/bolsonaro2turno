 ...
 *
 * Você pediu que ele acompanhasse o que você faz, para ser um segundo cérebro.
 ...
 * que sobrevive é o que virou memória, que é o ponto — o objetivo é ele te
...
export class Observador {
  ...
  async digerir(limite = 120): Promise<number> {
    ...
    const resultado = await extractStructured<{
      ...
      system: `Você analisa o registro de atividade do dono de um assistente pessoal: o que ele copiou e em que janelas trabalhou.
