...
export class Agent {
   ...
   *
   * O prompt de sistema é remontado aqui porque ele carrega o nome dele e o
   * seu: trocar isso na engrenagem e continuar respondendo com o nome antigo
   * até o próximo `npm start` seria esquisito. O preço é um único descarte de
   * cache de prompt no turno seguinte, que é barato e acontece uma vez.
   */
